...
- 2026-09-06: เพิ่มตัวแปร Resend ใน production compose โดยอ้างอิงจาก environment เท่านั้น; ยังไม่ใส่ secret/deploy เพราะ `APP_BASE_URL` ที่ให้มายังเป็น placeholder
